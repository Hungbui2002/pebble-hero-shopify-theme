...
})(document.querySelector('section.lh-bxn84y'), 'live');
...
})(document.querySelector('section.lh-8af62l'), 'live');
}catch(ex){console.error(ex)}
...
})(document.querySelector('section.lh-kfnqj7'), 'live');
}catch(ex){console.error(ex)}
...
})(document.querySelector('section.lh-xs7w95'), 'live');
}catch(ex){console.error(ex)}
...
})(document.querySelector('section.lh-v4z53x'), 'live');
}catch(ex){console.error(ex)}
...
})(document.querySelector('section.lh-dbxdm3'), 'live');
}catch(ex){console.error(ex)}
